<template lang="">
    <div class="2xl:max-w-7xl 2xl:px-0 min-h-[507px] h-full grid lg:grid-cols-12 gap-10 mx-auto px-6 py-16">
...
<script setup> 
import Freelance from '../icons/Freelance.vue'
